...
export interface WaterDisplacementStrategy {
  move(water: Water, previousPosition: THREE.Vector3, position: THREE.Vector3): void
}
...
export class SphereWaterDisplacement implements WaterDisplacementStrategy {
  ...
  move(water: Water, previousPosition: THREE.Vector3, position: THREE.Vector3) {
    water.moveSphere(previousPosition, position, this.radius)
  }
}
...
export class BoxWaterDisplacement implements WaterDisplacementStrategy {
  ...
  move(water: Water, previousPosition: THREE.Vector3, position: THREE.Vector3) {
    water.moveCube(previousPosition, position, this.halfSize)
  }
}
